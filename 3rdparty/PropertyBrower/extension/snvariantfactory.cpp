...
SnVariantFactory::~SnVariantFactory()
{
...
void SnVariantFactory::connectPropertyManager(QtVariantPropertyManager *manager)
{
...
void SnVariantFactory::disconnectPropertyManager(QtVariantPropertyManager *manager)
{
...
void SnVariantFactory::slotPropertyChanged(QtProperty *property,
...
void SnVariantFactory::slotPropertyAttributeChanged(QtProperty *property,
...
void SnVariantFactory::slotSetValue(const QString &value)
{
...
void SnVariantFactory::slotEditorDestroyed(QObject *object)
{
    QMap<FileEdit *, QtProperty *>::ConstIterator itEditor =
                theEditorToProperty.constBegin();
    while (itEditor != theEditorToProperty.constEnd()) {
